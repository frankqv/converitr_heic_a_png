...
def obtener_ruta_base():
    ...
    print("1. Usar carpeta por defecto (Descargas/BATERIAS)")
...
def convertir_heic_a_png(ruta_base):
    ...
    for carpeta_actual, subcarpetas, archivos in os.walk(ruta_base):
        ...
        archivos_heic = [archivo for archivo in archivos if archivo.lower().endswith(('.heic', '.heif'))]
    ...
    if contador_convertidos > 0:
        ...
        eliminar = input("\n¿Deseas eliminar los archivos HEIC originales? (s/n): ").strip().lower()
